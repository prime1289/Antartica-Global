...
SELECT LeadDate, Day, [No of leads],[Time Spent on LG (in mins)] FROM AssociateABC
...
SELECT TOP 1 LeadDate, LeadDate, Day, [No of leads] as Maxleads,[Time Spent on LG (in mins)]
FROM AssociateABC
...
--Avg Lead genrated basis of week days
...
--Avg time spent on lead basis on week days
